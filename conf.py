...
BLOG_AUTHOR = "Samuel Barton"  # (translatable)
BLOG_TITLE = "Samuel's Github Pages Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://samuel-barton.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://samuel-barton.github.io/"
BLOG_EMAIL = "samwisebarton@gmail.com"
BLOG_DESCRIPTION = "This is a test of the Nikola-based blogging system."  # (translatable)
